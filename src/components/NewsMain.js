  ...
  return (
    <div className="columna-newsmain" onClick={redirect}>
      <div className="card text-center">
        <img src="https://img.thedailybeast.com/image/upload/c_crop,d_placeholder_euli9k,h_1693,w_3009,x_0,y_168/dpr_2.0/c_limit,w_740/fl_lossy,q_auto/v1655764574/GettyImages-1288827236_rwklat"  className="card-img " alt="" />
